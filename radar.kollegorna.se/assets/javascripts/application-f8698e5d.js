...
!function(e, t) {
  ...
  function d(e, t) {
    return Z.nodeName(e, "table") && Z.nodeName(11 !== t.nodeType
      ? t
      : t.firstChild, "tr")
  ...
  function x(e) {
    var t = J,
      n = Re[e];
    return n || (n = b(e, t), "none" !== n && n || (Me = (Me || Z("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = Me[0].contentDocument, t.write(), t.close(), n = b(e, t), Me.detach()), Re[e] = n),
    n
  }
  function w(e, t, n) {
    var r,
    ...
    n && ("" !== s || Z.contains(e.ownerDocument, e) || (s = Z.style(e, t)), We.test(s) && Be.test(t) && (r = a.width, i = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = r, a.minWidth = i, a.maxWidth = o)),
    void 0 !== s
      ? s + ""
      : s
  }
  ...
  function S(e, t, n, r, i) {
    for (var o = n === (r
      ...
      : "width" === t
        ? 1
        : 0, s = 0; o < 4; o += 2)
      "margin" === n && (s += Z.css(e, n + Ce[o], !0, i)),
      r
        ? ("content" === n && (s -= Z.css(e, "padding" + Ce[o], !0, i)), "margin" !== n && (s -= Z.css(e, "border" + Ce[o] + "Width", !0, i)))
        : (s += Z.css(e, "padding" + Ce[o], !0, i), "padding" !== n && (s += Z.css(e, "border" + Ce[o] + "Width", !0, i)));
    return s
  }
  function E(e, t, n) {
    var r = !0,
    ...
    if (i <= 0 || null == i) {
      if (i = w(e, t, o), (i < 0 || null == i) && (i = e.style[t]), We.test(i))
        return i;
  ...
  function N(e, t) {
    for (var n, r, i, o = [], s = 0, a = e.length; s < a; s++)
      r = e[s],
      r.style && (o[s] = ve.get(r, "olddisplay"), n = r.style.display, t
        ? (o[s] || "none" !== n || (r.style.display = ""), "" === r.style.display && Te(r) && (o[s] = ve.access(r, "olddisplay", x(r.nodeName))))
        : (i = Te(r), "none" === n && i || ve.set(r, "olddisplay", i
          ? n
          : Z.css(r, "display"))));
    for (s = 0; s < a; s++)
      r = e[s],
  ...
  function _(e, t, n) {
    ...
    ], l = Z.css(e, "display"), c = "none" === l
      ? ve.get(e, "olddisplay") || x(e.nodeName)
      : l, "inline" === c && "none" === Z.css(e, "float") && (p.display = "inline-block")),
    ...
    for (r in t)
      if (i = t[r], Qe.exec(i)) {
        if (delete t[r], o = o || "toggle" === i, i === (h
          ? "hide"
          : "show")) {
    ...
    if (Z.isEmptyObject(d))
      ...
      for (r in d)
        s = j(h
          ? m[r]
          : 0, r, f),
        r in m || (m[r] = s.start, h && (s.end = s.start, s.start = "width" === r || "height" === r
          ? 1
          : 0))
      }
  }
  ...
  function q(e, t, n) {
    var r,
      ...
      u = function() {
        if (i)
          return !1;
        for (var t = Ge || D(), n = Math.max(0, l.startTime + l.duration - t), r = n / l.duration || 0, o = 1 - r, s = 0, u = l.tweens.length; s < u; s++)
          l.tweens[s].run(o);
    ...
    for ("boolean" == typeof s && (l = s, s = arguments[a] || {}, a++), "object" == typeof s || Z.isFunction(s) || (s = {}), a === u && (s = this, a--); a < u; a++)
      if (null != (e = arguments[a]))
        for (t in e)
          n = s[t],
          r = e[t],
          s !== r && (l && r && (Z.isPlainObject(r) || (i = Z.isArray(r)))
            ? (i
              ? (i = !1, o = n && Z.isArray(n)
                ? n
                : [])
              : o = n && Z.isPlainObject(n)
                ? n
                : {}, s[t] = Z.extend(l, o, r))
            : void 0 !== r && (s[t] = r));
    return s
  ...
  Z.extend({
    ...
    globalEval: function(e) {
      ...
      e && (1 === e.indexOf("use strict")
        ? (t = J.createElement("script"), t.text = e, J.head.appendChild(t).parentNode.removeChild(t))
        : n(e))
    },
 ...
 */
  function(e) {
    function t(e, t, n, r) {
      ...
      if ((t
        ? t.ownerDocument || t
        : R) !== _ && j(t), t = t || _, n = n || [], a = t.nodeType, "string" != typeof e || !e || 1 !== a && 9 !== a && 11 !== a)
        return n;
      if (!r && q) {
        if (11 !== a && (i = ye.exec(e)))
          if (s = i[1]) {
        ...
        if (w.qsa && (!L || !L.test(e))) {
          if (p = f = M, h = t, m = 1 !== a && e, 1 === a && "object" !== t.nodeName.toLowerCase()) {
            for (l = S(e), (f = t.getAttribute("id"))
              ? p = f.replace(xe, "\\$&")
              : t.setAttribute("id", p), p = "[id='" + p + "'] ", u = l.length; u--;)
              l[u] = p + d(l[u]);
      ...
      return t.first
        ...
        : function(t, n, s) {
          ...
          if (s) {
            ...
            for (; t = t[r];)
              if (1 === t.nodeType || i) {
                if (u = t[M] || (t[M] = {}), (a = u[r]) && a[0] === B && a[1] === o)
                  return l[2] = a[2];
      ...
      r(function(r, s, a, u) {
        var l,
          ...
          b = n
            ...
            : y;
        if (n && n(y, b, a, u), i)
          for (l = g(b, p), i(l, [], a, u), c = l.length; c--;)
            (f = l[c]) && (b[p[c]] = !(y[p[c]] = f));
      if (r) {
          if (o || e) {
            if (o) {
    ...
    function y(e) {
      for (var t, n, r, i = e.length, o = C.relative[e[0].type], s = o || C.relative[" "], a = o
        ? 1
        : 0, u = p(function(e) {
        return e === t
      }, s, !0), l = p(function(e) {
    ...
    try {
      Q.apply(Y = Z.call(R.childNodes), R.childNodes),
    ...
    j = t.setDocument = function(e) {
      ...
      return r !== _ && 9 === r.nodeType && r.documentElement
        ? (_ = r, A = r.documentElement, n = r.defaultView, n && n !== n.top && (n.addEventListener
          ? n.addEventListener("unload", Te, !1)
          : n.attachEvent && n.attachEvent("onunload", Te)), q = !k(r), w.attributes = i(function(e) {
        ...
        (w.qsa = ve.test(r.querySelectorAll)) && (i(function(e) {
          A.appendChild(e).innerHTML = "<a id='" + M + "'></a><select id='" + M + "-\f]' msallowcapture=''><option selected=''></option></select>",
          ...
          ? function(e, t) {
            ...
            return n
              ...
              : (n = (e.ownerDocument || e) === (t.ownerDocument || t)
                ...
                ? e === r || e.ownerDocument === R && H(R, e)
                  ? -1
                  : t === r || t.ownerDocument === R && H(R, t)
                    ? 1
                    : D
                      ? ee(D, e) - ee(D, t)
                      : 0
    ...
    t.matchesSelector = function(e, n) {
      if ((e.ownerDocument || e) !== _ && j(e), n = n.replace(fe, "='$1']"), w.matchesSelector && q && (!O || !O.test(n)) && (!L || !L.test(n)))
        try {
          var r = F.call(e, n);
    ...
    t.attr = function(e, t) {
      ...
      var n = C.attrHandle[t.toLowerCase()],
        r = n && K.call(C.attrHandle, t.toLowerCase())
          ? n(e, t, !q)
          : void 0;
      return void 0 !== r
        ? r
      ...
      preFilter: {
        ...
        PSEUDO: function(e) {
          ...
          return he.CHILD.test(e[0])
            ...
            : (e[3]
              ? e[2] = e[4] || e[5] || ""
              : n && de.test(n) && (t = S(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t), e[2] = n.slice(0, t)), e.slice(0, 3))
        }
      },
      filter: {
        TAG: function(e) {
            ...
            : function(t, n, u) {
              ...
              if (g) {
                ...
                if (h = [s
                  ...
                  } else if (y && (l = (t[M] || (t[M] = {}))[e]) && l[0] === B)
                  d = l[1];
                else
                  for (; (f = ++p && f && f[m] || (d = p = 0) || h.pop()) && ((a
                    ? f.nodeName.toLowerCase() !== v
                    : 1 !== f.nodeType) || !++d || (y && ((f[M] || (f[M] = {}))[e] = [B, d]), f !== t));)
                  ;
                  return d -= i,
                  d === r || d % r === 0 && d / r >= 0
              }
    ...
    N = t.select = function(e, t, n, r) {
      ...
      if (n = n || [], 1 === f.length) {
        ...
        for (i = he.needsContext.test(e)
          ? 0
          : o.length; i-- && (s = o[i], !C.relative[a = s.type]);)
      ...
      return (l || E(e, f))(r, t, !q, n, be.test(e) && c(t.parentNode) || t),
      n
    },
  ...
  Z.fn.extend({
    ...
    is: function(e) {
      return !!r(this, "string" == typeof e && oe.test(e)
        ? Z(e)
        : e || [], !1).length
    }
  });
    ...
    ce = Z.fn.init = function(e, t) {
      ...
      if ("string" == typeof e) {
        ...
        if (n[1]) {
          if (t = t instanceof Z
            ? t[0]
            : t, Z.merge(this, Z.parseHTML(n[1], t && t.nodeType
            ? t.ownerDocument || t
            : J, !0)), se.test(n[1]) && Z.isPlainObject(t))
            for (n in t)
              Z.isFunction(this[n])
                ? this[n](t[n])
                : this.attr(n, t[n]);
  ...
  Z.fn.extend({
    ...
    closest: function(e, t) {
      for (var n, r = 0, i = this.length, o = [], s = oe.test(e) || "string" != typeof e
        ? Z(e, t || this.context)
        : 0; r < i; r++)
  ...
  Z.extend({
    ...
    when: function(e) {
      var t,
        ...
        o = z.call(arguments),
        s = o.length,
        a = 1 !== s || e && Z.isFunction(e.promise)
          ? s
          : 0,
        u = 1 === a
          ? e
  ...
  Z.extend({
    ...
    holdReady: function(e) {
      e
        ? Z.readyWait ++: Z.ready(!0)
    },
    ready: function(e) {
      (e === !0
        ? --Z.readyWait
        : Z.isReady) || (Z.isReady = !0, e !== !0 && --Z.readyWait > 0 || (me.resolveWith(J, [Z]), Z.fn.triggerHandler && (Z(J).triggerHandler("ready"), Z(J).off("ready"))))
    }
  }),
  Z.ready.promise = function(t) {
    return me || (me = Z.Deferred(), "complete" === J.readyState
      ? setTimeout(Z.ready)
      : (J.addEventListener("DOMContentLoaded", s, !1), e.addEventListener("load", s, !1))),
    me.promise(t)
  },
  Z.ready.promise();
  var ge = Z.access = function(e, t, n, r, i, o, s) {
    ...
    } else if (void 0 !== r && (i = !0, Z.isFunction(r) || (s = !0), l && (s
      ? (t.call(e, r), t = null)
  ...
  Z.event = {
    ...
    add: function(e, t, n, r, i) {
      ...
      if (g)
        for (n.handler && (o = n, n = o.handler, i = o.selector), n.guid || (n.guid = Z.guid++), (u = g.events) || (u = g.events = {}), (s = g.handle) || (s = g.handle = function(t) {
          ...
          p = m = a[1],
          h = (a[2] || "").split(".").sort(),
          p && (f = Z.event.special[p] || {}, p = (i
            ? f.delegateType
            : f.bindType) || p, f = Z.event.special[p] || {}, c = Z.extend({
            type: p,
            origType: m,
            data: r,
            handler: n,
            ...
            namespace: h.join(".")
          }, o), (d = u[p]) || (d = u[p] = [], d.delegateCount = 0, f.setup && f.setup.call(e, r, h, s) !== !1 || e.addEventListener && e.addEventListener(p, s, !1)), f.add && (f.add.call(e, c), c.handler.guid || (c.handler.guid = n.guid)), i
            ? d.splice(d.delegateCount++, 0, c)
            : d.push(c), Z.event.global[p] = !0)
      },
      ...
      if (g && (u = g.events)) {
        for (t = (t || "").match(pe) || [""], l = t.length; l--;)
          if (a = De.exec(t[l]) || [], p = m = a[1], h = (a[2] || "").split(".").sort(), p) {
            for (f = Z.event.special[p] || {}, p = (r
              ? f.delegateType
              : f.bindType) || p, d = u[p] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = d.length; o--;)
              c = d[o],
              !i && m !== c.origType || n && n.guid !== c.guid || a && !a.test(c.namespace) || r && r !== c.selector && ("**" !== r || !c.selector) || (d.splice(o, 1), c.selector && d.delegateCount--, f.remove && f.remove.call(e, c));
    ...
    trigger: function(t, n, r, i) {
      var o,
        ...
        p = Y.call(t, "type")
          ? t.type
          : t,
        h = Y.call(t, "namespace")
          ? t.namespace.split(".")
          : [];
      if (s = a = r = r || J, 3 !== r.nodeType && 8 !== r.nodeType && !Pe.test(p + Z.event.triggered) && (p.indexOf(".") >= 0 && (h = p.split("."), p = h.shift(), h.sort()), l = p.indexOf(":") < 0 && "on" + p, t = t[Z.expando]
        ? t
        : new Z.Event(p, "object" == typeof t && t), t.isTrigger = i
        ? 2
        : 3, t.namespace = h.join("."), t.namespace_re = t.namespace
        ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)")
        : null, t.result = void 0, t.target || (t.target = r), n = null == n
        ? [t]
        : Z.makeArray(n, [t]), f = Z.event.special[p] || {}, i || !f.trigger || f.trigger.apply(r, n) !== !1)) {
        if (!i && !f.noBubble && !Z.isWindow(r)) {
          for (u = f.delegateType || p, Pe.test(u + p) || (s = s.parentNode); s; s = s.parentNode)
            d.push(s),
            a = s;
        ...
        return t.type = p,
        i || t.isDefaultPrevented() || f._default && f._default.apply(d.pop(), n) !== !1 || !Z.acceptData(r) || l && Z.isFunction(r[p]) && !Z.isWindow(r) && (a = r[l], a && (r[l] = null), Z.event.triggered = p, r[p](), Z.event.triggered = void 0, a && (r[l] = a)),
        t.result;
      }
    },
    dispatch: function(e) {
    ...
    fix: function(e) {
      ...
      var t,
        ...
        o = e,
        s = this.fixHooks[i];
      for (s || (this.fixHooks[i] = s = Ne.test(i)
        ? this.mouseHooks
        : Ee.test(i)
          ? this.keyHooks
          : {}), r = s.props
        ? this.props.concat(s.props)
        : this.props, e = new Z.Event(o), t = r.length; t--;)
        n = r[t],
        e[n] = o[n];
    ...
    simulate: function(e, t, n, r) {
      ...
      r
        ? Z.event.trigger(i, null, t)
        : Z.event.dispatch.call(t, i),
    ...
    return this instanceof Z.Event
      ? (e && e.type
        ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && e.returnValue === !1
          ? l
          : c)
        : this.type = e, t && Z.extend(this, t), this.timeStamp = e && e.timeStamp || Z.now(), void(this[Z.expando] = !0))
      : new Z.Event(e, t)
  },
  Z.Event.prototype = {
  ...
  Z.extend({
    ...
    buildFragment: function(e, t, n, r) {
      for (var i, o, s, a, u, l, c = t.createDocumentFragment(), f = [], d = 0, p = e.length; d < p; d++)
        if (i = e[d], i || 0 === i)
          if ("object" === Z.type(i))
            Z.merge(f, i.nodeType
              ? [i]
              : i);
          else if (_e.test(i)) {
            for (o = o || c.appendChild(t.createElement("div")), s = (je.exec(i) || ["", ""])[1].toLowerCase(),
            a = He[s] || He._default,
            o.innerHTML = a[1] + i.replace($e, "<$1></$2>") + a[2],
            l = a[0]; l--;)
              o = o.lastChild;
  ...
  Z.fn.extend({
    ...
    domManip: function(e, t) {
      ...
      var n,
        ...
        d = e[0],
        m = Z.isFunction(d);
      if (m || l > 1 && "string" == typeof d && !G.checkClone && qe.test(d))
      ...
      if (l && (n = Z.buildFragment(e, this[0].ownerDocument, !1, this), r = n.firstChild, 1 === n.childNodes.length && (n = r), r)) {
        for (i = Z.map(v(n, "script"), p), o = i.length; u < l; u++)
          s = n,
          u !== f && (s = Z.clone(s, !0, !0), o && Z.merge(i, v(s, "script"))),
          t.call(this[u], s, u);
        if (o)
          for (a = i[i.length - 1].ownerDocument, Z.map(i, h), u = 0; u < o; u++)
            s = i[u],
            Le.test(s.type || "") && !ve.access(s, "globalEval") && Z.contains(a, s) && (s.src
  ...
  Z.extend({
      ...
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        ...
        void 0 === n
          ? s && "get" in s && void 0 !== (i = s.get(e, !1, r))
            ? i
            : u[t]
          : (o = typeof n, "string" === o && (i = Xe.exec(n)) && (n = (i[1] + 1) * i[2] + parseFloat(Z.css(e, t)), o = "number"), null != n && n === n && ("number" !== o || Z.cssNumber[a] || (n += "px"), G.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, r)) || (u[t] = n)), void 0)
      }
    },
    css: function(e, t, n, r) {
      ...
      "" === n || n
        ? (o = parseFloat(i), n === !0 || Z.isNumeric(o)
          ? o || 0
          : i)
        : i
    }
  ...
  Z.each([
    ...
    Z.cssHooks[t] = {
      get: function(e, n, r) {
        if (n)
          return Ie.test(Z.css(e, "display")) && 0 === e.offsetWidth
      ...
      set: function(e, n, r) {
        var i = r && ze(e);
        return k(e, n, r
          ? S(e, t, r, "border-box" === Z.css(e, "boxSizing", !1, i), i)
          : 0)
      }
    }
  }),
  ...
  P.prototype = {
    ...
    run: function(e) {
      ...
      return this.options.duration
        ? this.pos = t = Z.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration)
        : this.pos = t = e,
    ...
    _default: {
      get: function(e) {
        ...
        return null == e.elem[e.prop] || e.elem.style && null != e.elem.style[e.prop]
          ? (t = Z.css(e.elem, e.prop, ""), t && "auto" !== t
            ? t
            : 0)
          : e.elem[e.prop]
      },
      set: function(e) {
        Z.fx.step[e.prop]
          ? Z.fx.step[e.prop](e)
          : e.elem.style && (null != e.elem.style[Z.cssProps[e.prop]] || Z.cssHooks[e.prop])
    ...
    attr: function(e, t, n) {
      ...
      if (e && 3 !== o && 8 !== o && 2 !== o)
        return typeof e.getAttribute === Se
          ? Z.prop(e, t, n)
          : (1 === o && Z.isXMLDoc(e) || (t = t.toLowerCase(), r = Z.attrHooks[t] || (Z.expr.match.bool.test(t)
            ? it
            : rt)), void 0 === n
            ? r && "get" in r && null !== (i = r.get(e, t))
              ? i
              : (i = Z.find.attr(e, t), null == i
                ? void 0
                : i)
            : null !== n
  ...
  Z.each(Z.expr.match.bool.source.match(/\w+/g), function(e, t) {
    ...
    ot[t] = function(e, t, r) {
      var i,
        o;
      return r || (o = ot[t], ot[t] = i, i = null != n(e, t, r)
        ? t.toLowerCase()
        : null, ot[t] = o),
      i
    }
        ...
        : Z.isFunction(e)
          ...
          : this.each(function() {
            if ("string" === n)
              ...
              n !== Se && "boolean" !== n || (this.className && ve.set(this, "__className__", this.className), this.className = this.className || e === !1
                ? ""
        ...
        i = this[0];
      {
        if (arguments.length)
          ...
          this.each(function(n) {
            var i;
            1 === this.nodeType && (i = r
              ? e.call(this, n, Z(this).val())
              : e, null == i
              ? i = ""
              : "number" == typeof i
                ? i += ""
                : Z.isArray(i) && (i = Z.map(i, function(e) {
                  return null == e
                    ? ""
                    : e + ""
        ...
        get: function(e) {
          for (var t, n, r = e.options, i = e.selectedIndex, o = "select-one" === e.type || i < 0, s = o
            ...
            : o
              ? i
              : 0; u < a; u++)
            if (n = r[u], (n.selected || u === i) && (G.optDisabled
              ? !n.disabled
              : null === n.getAttribute("disabled")) && (!n.parentNode.disabled || !Z.nodeName(n.parentNode, "optgroup"))) {
              if (t = Z(n).val(), o)
                return t;
              s.push(t)
            }
    ...
    ajax: function(e, t) {
      function n(e, t, n, s) {
        var u,
          ...
          x,
          C = t;
        2 !== b && (b = 2, a && clearTimeout(a), r = void 0, o = s || "", w.readyState = e > 0
          ? 4
          : 0, u = e >= 200 && e < 300 || 304 === e, n && (y = H(f, w, n)), y = M(f, y, w, u), u
          ? (f.ifModified && (x = w.getResponseHeader("Last-Modified"), x && (Z.lastModified[i] = x), x = w.getResponseHeader("etag"), x && (Z.etag[i] = x)), 204 === e || "HEAD" === f.type
            ? C = "nocontent"
            : 304 === e
              ? C = "notmodified"
              : (C = y.state, c = y.data, v = y.error, u = !v))
          : (v = C, !e && C || (C = "error", e < 0 && (e = 0))), w.status = e, w.statusText = (t || C) + "", u
          ? h.resolveWith(d, [c, C, w])
          : h.rejectWith(d, [w, C, v]), w.statusCode(g), g = void 0, l && p.trigger(u
          ? "ajaxSuccess"
          : "ajaxError", [
          w, f, u
            ? c
            : v
        ]), m.fireWith(d, [w, C]), l && (p.trigger("ajaxComplete", [w, f]), --Z.active || Z.event.trigger("ajaxStop")))
      }
      ...
      var r,
        ...
        f = Z.ajaxSetup({}, t),
        d = f.context || f,
        p = f.context && (d.nodeType || d.jquery)
          ? Z(d)
          : Z.event,
        h = Z.Deferred(),
      ...
      if (h.promise(w).complete = m.add, w.success = w.done, w.error = w.fail, f.url = ((e || f.url || wt) + "").replace(ft, "").replace(gt, Ct[1] + "//"), f.type = t.method || t.type || f.method || f.type, f.dataTypes = Z.trim(f.dataType || "*").toLowerCase().match(pe) || [""], null == f.crossDomain && (u = vt.exec(f.url.toLowerCase()), f.crossDomain = !(!u || u[1] === Ct[1] && u[2] === Ct[2] && (u[3] || ("http:" === u[1]
        ? "80"
        : "443")) === (Ct[3] || ("http:" === Ct[1]
        ? "80"
        : "443")))), f.data && f.processData && "string" != typeof f.data && (f.data = Z.param(f.data, f.traditional)), O(yt, f, t, w), 2 === b)
        return w;
      l = Z.event && f.global,
      ...
      i = f.url,
      f.hasContent || (f.data && (i = f.url += (ct.test(i)
        ? "&"
        : "?") + f.data, delete f.data), f.cache === !1 && (f.url = dt.test(i)
        ? i.replace(dt, "$1_=" + lt++)
        : i + (ct.test(i)
          ? "&"
          : "?") + "_=" + lt++)),
      ...
      w.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]]
    ...
    if (G.cors || jt && !e.crossDomain)
      return {
        ...
        e.mimeType && o.overrideMimeType && o.overrideMimeType(e.mimeType),
          ...
          t = function(e) {
            return function() {
              t && (delete Dt[s], t = o.onload = o.onerror = null, "abort" === e
                ? o.abort()
                : "error" === e
                  ? r(o.status, o.statusText)
                  : r($t[o.status] || o.status, o.statusText, "string" == typeof o.responseText
                    ? {
                      text: o.responseText
                    }
  ...
  Z.ajaxPrefilter("json jsonp", function(t, n, r) {
    var i,
      o,
      s,
      a = t.jsonp !== !1 && (At.test(t.url)
        ? "url"
        : "string" == typeof t.data && !(t.contentType || "").indexOf("application/x-www-form-urlencoded") && At.test(t.data) && "data");
    if (a || "jsonp" === t.dataTypes[0])
      return i = t.jsonpCallback = Z.isFunction(t.jsonpCallback)
        ? t.jsonpCallback()
        : t.jsonpCallback,
      a
        ? t[a] = t[a].replace(At, "$1" + i)
        : t.jsonp !== !1 && (t.url += (ct.test(t.url)
          ? "&"
          : "?") + t.jsonp + "=" + i),
  ...
  Z.parseHTML = function(e, t, n) {
    ...
    return r
      ? [t.createElement(r[1])]
      : (r = Z.buildFragment([e], t, i), i && i.length && Z(i).remove(), Z.merge([], r.childNodes))
  };
  var qt = Z.fn.load;
  Z.fn.load = function(e, t, n) {
    ...
    s.length > 0 && Z.ajax({url: e, type: i, dataType: "html", data: t}).done(function(e) {
      o = arguments,
      s.html(r
  ...
  Z.fn.extend({
    offset: function(e) {
      ...
      if (o)
        ...
        Z.contains(t, r)
          ? (typeof r.getBoundingClientRect !== Se && (i = r.getBoundingClientRect()), n = B(o), {
    ...
    offsetParent: function() {
      return this.map(function() {
        for (var e = this.offsetParent || Lt; e && !Z.nodeName(e, "html") && "static" === Z.css(e, "position");)
          e = e.offsetParent;
        return e || Lt
      })
    }
...
!function(e, t) {
  ...
  var r = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
    ...
    s = function() {
      function e(t, r, i) {
        n(this, e),
        this.routeEvents(t, r, i),
        this.preventSelect(t, i)
      }
      return i(e, [
        {
          key: "routeEvents",
          value: function(e, t, n) {
            var r = f.get("only", n);
            this.adapter = !v || "pointer" !== r && null !== r
              ? !g || "touch" !== r && null !== r
                ? !m || "mouse" !== r && null !== r
                  ? new a(e, t).bindUnsupportedEvent()
                  : new u(e, t, n).bindEvents()
                : new l(e, t, n).bindEvents()
              : new c(e, t, n).bindEvents()
          }
        }, {
          key: "preventSelect",
          value: function(e, t) {
      ...
      return i(e, [
        {
          ...
          value: function(e, t) {
            e >= .5
              ? this._startDeepPress(t)
              : this._endDeepPress()
          }
        }, {
          key: "runPolyfill",
          value: function(e) {
            this.increment = 0 === f.get("polyfillSpeedUp", this.options)
              ? 1
              : 10 / f.get("polyfillSpeedUp", this.options),
            this.decrement = 0 === f.get("polyfillSpeedDown", this.options)
              ? 1
              : 10 / f.get("polyfillSpeedDown", this.options),
            this.setPressed(!0),
            this.runClosure("start", e),
            this.runningPolyfill === !1 && this.loopPolyfillForce(0, e)
          }
        }, {
          key: "loopPolyfillForce",
          value: function(e, t) {
            this.nativeSupport === !1 && (this.isPressed()
              ? (this.runningPolyfill = !0, e = e + this.increment > 1
                ? 1
                : e + this.increment, this.runClosure("change", e, t), this.deepPress(e, t), setTimeout(this.loopPolyfillForce.bind(this, e, t), 10))
              : (e = e - this.decrement < 0
                ? 0
                : e - this.decrement, e < .5 && this.isDeepPressed() && (this.setDeepPressed(!1), this.runClosure("endDeepPress")), 0 === e
                ? (this.runningPolyfill = !1, this.setPressed(!0), this._endPress())
                : (this.runClosure("change", e, t), this.deepPress(e, t), setTimeout(this.loopPolyfillForce.bind(this, e, t), 10))))
          }
        }
      ]),
      e
    ...
    u = function(r) {
      function o(t, r, i) {
        return n(this, o),
        e(this, (o.__proto__ || Object.getPrototypeOf(o)).call(this, t, r, i))
      }
      return t(o, r),
      i(o, [
        {
      ...
      i(o, [
        {
          ...
          value: function() {
            b
              ? (this.add("touchforcechange", this.start.bind(this)), this.add("touchstart", this.support.bind(this, 0)), this.add("touchend", this._endPress.bind(this)))
              : (this.add("touchstart", this.startLegacy.bind(this)), this.add("touchend", this._endPress.bind(this)))
          }
        }, {
          key: "start",
          value: function(e) {
          ...
          value: function(e, t) {
            var n = arguments.length > 2 && void 0 !== arguments[2]
              ? arguments[2]
              : this.runKey;
            this.isPressed() === !1 && (e <= 6
              ? (e++, setTimeout(this.support.bind(this, e, t, n), 10))
              : this.fail(t, n))
          }
        }, {
          key: "startLegacy",
          ...
          value: function(e, t, n, r) {
            r !== this.initialForce
              ...
              : e <= 6
                ? (e++, setTimeout(this.supportLegacy.bind(this, e, t, n, r), 10))
                : this.fail(t, n)
          }
        }, {
          key: "loopForce",
          ...
          value: function(e) {
            ...
            for (var t = 0; t < e.touches.length; t++)
              if (e.touches[t].target === this.el || this.el.contains(e.touches[t].target))
                return this.returnTouch(e.touches[t], e)
          }
        }, {
          key: "returnTouch",
          value: function(e, t) {
            return this.deepPress(e.force, t),
            e
          }
        }
      ]),
      ...
      i(o, [
        {
          ...
          key: "support",
          value: function(e) {
            this.isPressed() === !1 && (0 === e.pressure || .5 === e.pressure
    ...
    f = {
      ...
      set: function(e) {
        for (var t in e)
          e.hasOwnProperty(t) && this.hasOwnProperty(t) && "get" != t && "set" != t && (this[t] = e[t])
      }
    },
    d = function(e, t) {
      var n = arguments.length > 2 && void 0 !== arguments[2]
    ...
    p = function(e) {
      return "object" === ("undefined" == typeof HTMLElement
        ...
        : e && "object" === (void 0 === e
          ? "undefined"
          : r(e)) && null !== e && 1 === e.nodeType && "string" == typeof e.nodeName
    },
  ...
  if ("undefined" != typeof window) {
    ...
    g = "ontouchstart" in window.document && y,
    m = "onmousemove" in window.document && !g,
    v = "onpointermove" in window.document,
    b = "ontouchforcechange" in window.document
  }
  return o
}),
...
!function(e, t, n) {
  ...
  function i() {
    ...
    for (var u in b)
      ...
      for (i = r(t.fn, "function")
          ? t.fn()
          : t.fn, o = 0; o < e.length; o++)
          s = e[o],
          a = s.split("."),
          1 === a.length
            ? w[a[0]] = i
            : (!w[a[0]] || w[a[0]]instanceof Boolean || (w[a[0]] = new Boolean(w[a[0]])), w[a[0]][a[1]] = i),
          y.push((i
            ? ""
            : "no-") + a.join("-"))
        }
  ...
  function o(e) {
    ...
    w._config.enableClasses && (t += " " + n + e.join(" " + n), T
  ...
  return o = s("style"),
    ...
    d.id = f,
    p.fake && (p.style.background = "", p.style.overflow = "hidden", c = C.style.overflow, C.style.overflow = "hidden", C.appendChild(p)),
    a = n(d, e),
    p.fake
      ? (p.parentNode.removeChild(p), C.style.overflow = c, C.offsetHeight)
  ...
  function g(e, t, i, o) {
    ...
    for (var f, d, p, h, g, v = ["modernizr", "tspan", "samp"]; !_.style && v.length;)
      f = !0,
      _.modElem = s(v.shift()),
      ...
      positionBlips: function() {
        if ($(".radar").length) {
          ...
          $($(".blip").get().reverse()).each(function(s) {
            r = $(this).closest("section").width() / 2,
            n = r,
            i = $(this).attr("data-angle"),
            o = $(this).attr("data-distance"),
            r = r - t / 8 + t / 8 * o,
            ...
            e
              ? (setTimeout(c.bind(this), 50 * s), setTimeout(f.bind(this), 1e3 + 50 * s))
              : setTimeout(c.bind(this), 25 * s)
          }),
          e = !1
        } else {
          var s = 0,
      ...
      addBinders: function() {
        ...
        Pressure.set(".blip", {
          change: function(e) {
            0 === e
              ...
              : e < 1
                ? (n.blipHover($(this)), $(".radar__chart").css("opacity", 1 - .75 * e))
                : t || n.openBlip($(this))
          },
          end: function() {
        ...
        $("#grid").click(function() {
          ...
          $(".radar").fadeOut(function() {
            $(this).addClass("grid").removeClass("radar"),
            setTimeout(function() {
              $(".grid").fadeIn(),
              n.positionBlips(!1)
            }, 100)
        ...
        $("#radar").click(function() {
          ...
          $(".grid").fadeOut(function() {
            $(this).addClass("radar").removeClass("grid"),
            setTimeout(function() {
              $(".radar").fadeIn(),
              n.positionBlips(!1)
            }, 100)
